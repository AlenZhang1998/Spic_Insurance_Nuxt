<template>
  <DynamicPage v-bind="layout">
    <div class="about-us">
      ...
      <p class="image-box">
        <img :src="overviewImage" alt="公司园区形象" width="600px" />
      </p>

      <div class="rich-text">
        <p>
          <span>
            国家电投集团保险经纪有限公司是国家电投集团资本控股有限公司的全资子公司，注册资本金1亿元，前身中电投保险经纪（北京）有限公司，成立于2007年12月26日 。2015年9月，原中电投保险经纪公司与国核保险经纪公司合并重组为国家电投集团保险经纪有限公司。
          </span>
        </p>
        <p>
          <span>
